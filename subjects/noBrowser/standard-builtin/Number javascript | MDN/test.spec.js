...
describe('Numbers', () => {
  ...
  it('should be possible to create a hexadecimal number', () => {
    expect(0xbbb).toBe(3003);
  });

  it('should be possible to create a octal number', () => {
    expect(0o12).toBe(10);
  });

  it('should be possible to create a binary number', () => {
    expect(0b10).toBe(2);
  });

  it('should be possible to create a bignumber', () => {
    expect(2n).toBe(2n);
  });
});